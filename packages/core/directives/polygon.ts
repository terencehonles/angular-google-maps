...
export class AgmPolygon implements OnDestroy, OnChanges, AfterContentInit {
   ...
   */
  @Output() polyPathsChange = new EventEmitter<PolygonPathEvent>();
...
export interface PolygonPathEvent extends MVCEvent<google.maps.LatLng[] | google.maps.LatLngLiteral[]> {
}

export interface PathCollectionChangePolygonPathEvent extends PolygonPathEvent {
}

export interface PathChangePolygonPathEvent extends PolygonPathEvent {
  pathIndex: number;
}
